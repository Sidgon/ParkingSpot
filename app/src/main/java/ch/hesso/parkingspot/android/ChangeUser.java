...
public class ChangeUser extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            parkingspots = new EndPointAsyncTaskParkingspot().execute().get();
                        ...
                        try {
                            ...
                            if(parkingspots != null) {
                                for (Parkingspot parkingspot : parkingspots) {
                                    if (parkingspot.getIduser() == Long.parseLong(user.get(SessionManager.KEY_ID))) {
                                        new EndPointAsyncTaskParkingspot(parkingspot.getId(), "remove").execute();
                                        new EndPointAsyncTaskParkingspot(parkingspot.getId(), "delete").execute();
                                    }
                                }
                            }
